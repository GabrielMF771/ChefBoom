...
public class Assets {
    ...
    //TEXTURA TILES
    @Asset public static final AssetDescriptor<Texture> barrier = new AssetDescriptor<Texture>("barreira.png", Texture.class);
    @Asset public static final AssetDescriptor<Texture> ground1 = new AssetDescriptor<Texture>("chao1.png", Texture.class);
    @Asset public static final AssetDescriptor<Texture> ground2 = new AssetDescriptor<Texture>("chao2.png", Texture.class);
